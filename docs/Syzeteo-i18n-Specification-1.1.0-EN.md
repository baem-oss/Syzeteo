# Syzeteo – Internationalization Specification 1.1.0

Date: 2026-08-27

## 1. Goal

Syzeteo 1.1.0 ships with a clean and extensible internationalization layer for the complete application UI. English and German are included initially. Additional languages must be addable through locale catalogs without changing domain logic.
...
Syzeteo 1.1.0 ships with **493 translation keys** in each official catalog. The key sets are identical.

## 7. Definition of Done

Internationalization is complete for Syzeteo 1.1.0 when:
...
Compared with 1.0.0, 20 translation keys were added for US #26. They cover the `aborted` status, round-coverage display, abort/delete dialogs, and associated domain errors. The English and German key sets remain identical and placeholder contracts remain compatible.
